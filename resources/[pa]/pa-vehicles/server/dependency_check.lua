...
local REQUIRED_DEPENDENCIES = {
    { name = 'oxmysql', reason = 'Required before pa-vehicles can initialize safely.' },
    { name = 'ox_lib', reason = 'Required before pa-vehicles can initialize safely.' },
    { name = 'pma-voice', reason = 'Required before pa-vehicles can initialize safely.' },
    { name = 'ox_target', reason = 'Required before pa-vehicles can initialize safely.' },
    ...
    { name = 'pa-economy', reason = 'pa-economy processes repair costs, insurance claims, and impound fees.' },
    { name = 'pa-guard', reason = 'pa-guard provides anti-exploit rate limit and distance helpers.' },
    { name = 'pa-ui', reason = 'pa-ui provides branded notifications and vehicle UI wrappers.' },
}
