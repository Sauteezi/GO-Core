...
local REQUIRED_DEPENDENCIES = {
    { name = 'oxmysql', reason = 'Required before pa-story can initialize safely.' },
    { name = 'ox_lib', reason = 'Required before pa-story can initialize safely.' },
    { name = 'pma-voice', reason = 'Required before pa-story can initialize safely.' },
    { name = 'ox_target', reason = 'Required before pa-story can initialize safely.' },
