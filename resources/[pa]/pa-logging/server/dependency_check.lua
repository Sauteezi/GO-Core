...
local REQUIRED_DEPENDENCIES = {
    { name = 'oxmysql', reason = 'Required before pa-logging can initialize safely.' },
    { name = 'ox_lib', reason = 'Required before pa-logging can initialize safely.' },
    { name = 'pma-voice', reason = 'Required before pa-logging can initialize safely.' },
    { name = 'ox_target', reason = 'Required before pa-logging can initialize safely.' },
    { name = 'pa-core', reason = 'pa-core is the gameplay foundation and should be available before pa-logging consumes actor/player context.' },
}
