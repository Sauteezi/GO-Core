...
local REQUIRED_DEPENDENCIES = {
    { name = 'oxmysql', reason = 'Required before pa-dispatch can persist calls for staff review.' },
    { name = 'pa-core', reason = 'pa-core provides authoritative character identity for caller linkage.' },
    { name = 'pa-logging', reason = 'pa-logging is required for incident audit trails.' },
    { name = 'pa-ui', reason = 'pa-ui is required for in-game dispatch notifications and UX consistency.' },
    { name = 'pa-guard', reason = 'pa-guard is required for anti-spam/rate-limit protection.' },
}
