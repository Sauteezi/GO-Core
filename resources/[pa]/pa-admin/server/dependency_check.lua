...
local REQUIRED_DEPENDENCIES = {
    { name = 'oxmysql', reason = 'Required before pa-admin can initialize safely.' },
    { name = 'ox_lib', reason = 'Required before pa-admin can initialize safely.' },
    { name = 'pma-voice', reason = 'Required before pa-admin can initialize safely.' },
    { name = 'ox_target', reason = 'Required before pa-admin can initialize safely.' },
    { name = 'pa-core', reason = 'pa-core is the only hard gameplay dependency and must start first.' },
    { name = 'pa-perms', reason = 'pa-perms is required for staff role checks on admin actions.' },
