...
local REQUIRED_DEPENDENCIES = {
    { name = 'oxmysql', reason = 'Required before pa-hud can initialize safely.' },
    { name = 'ox_lib', reason = 'Required before pa-hud can initialize safely.' },
    { name = 'pma-voice', reason = 'Required before pa-hud can initialize safely.' },
    { name = 'ox_target', reason = 'Required before pa-hud can initialize safely.' },
    ...
    { name = 'pa-inventory', reason = 'pa-inventory provides RegisterUsableItem hook points for food/drink effects.' },
    { name = 'pa-economy', reason = 'pa-economy provides compact balance snapshots for HUD money display.' },
    { name = 'pa-guard', reason = 'pa-guard rate limits needs-related stress events and abuse attempts.' },
}
