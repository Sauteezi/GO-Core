...
local REQUIRED_DEPENDENCIES = {
    { name = 'oxmysql', reason = 'Required before pa-jobs can initialize safely.' },
    { name = 'ox_lib', reason = 'Required before pa-jobs can initialize safely.' },
    { name = 'pma-voice', reason = 'Required before pa-jobs can initialize safely.' },
    { name = 'ox_target', reason = 'Required before pa-jobs can initialize safely.' },
    ...
    { name = 'pa-shared', reason = 'pa-shared provides authoritative job definitions and starter requirements.' },
    { name = 'pa-economy', reason = 'pa-economy handles server-authoritative paycheck deposits.' },
    { name = 'pa-perms', reason = 'pa-perms tracks department duty state updates.' },
}
