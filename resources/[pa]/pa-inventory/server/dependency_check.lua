...
local REQUIRED_DEPENDENCIES = {
    { name = 'oxmysql', reason = 'Required before pa-inventory can initialize safely.' },
    { name = 'ox_lib', reason = 'Required before pa-inventory can initialize safely.' },
    { name = 'pma-voice', reason = 'Required before pa-inventory can initialize safely.' },
    { name = 'ox_target', reason = 'Required before pa-inventory can initialize safely.' },
    { name = 'ox_inventory', reason = 'Required backend for pa-inventory adapter item mutations and queries.' },
