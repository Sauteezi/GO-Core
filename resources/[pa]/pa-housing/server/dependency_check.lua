...
local REQUIRED_DEPENDENCIES = {
    { name = 'oxmysql', reason = 'Required before pa-housing can initialize safely.' },
    { name = 'ox_lib', reason = 'Required before pa-housing can initialize safely.' },
    { name = 'pma-voice', reason = 'Required before pa-housing can initialize safely.' },
    { name = 'ox_target', reason = 'Required before pa-housing can initialize safely.' },
    { name = 'pa-core', reason = 'pa-core is the only hard gameplay dependency and must start first.' },
    { name = 'pa-shared', reason = 'pa-shared provides property definitions and housing tuning values.' },
    { name = 'pa-logging', reason = 'pa-logging is required for economy/inventory/perms/admin/suspicious behavior audit traces.' },
    { name = 'pa-economy', reason = 'pa-economy processes purchase, rent, grants, and penalties.' },
    { name = 'pa-inventory', reason = 'pa-inventory backend provides ox stash integration for housing storage.' },
    { name = 'pa-ui', reason = 'pa-ui provides branded notification/prompt pathways for housing UX.' },
    { name = 'pa-guard', reason = 'pa-guard provides anti-exploit interaction checks.' },
}
